...
face_cascade = cv2.CascadeClassifier('/Users/gabriel/Downloads/haarcascade_frontalface_default.xml')
...
while True:
    ...
    if ret:
        ...
        for (x, y, w, h) in faces:
            ...
            hat = cv2.imread('/Users/gabriel/Downloads/funny_hat.png', cv2.IMREAD_UNCHANGED)

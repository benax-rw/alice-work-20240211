...
import sys
x = urllib.request.urlopen("http://192.168.0.82/Y2-CAT2-Term1-2021~2022/?rq=get-embeddedsystems-cat-08dec2021-questions").read()
y = json.loads(x)
system("clear")
print("Rwanda Coding Academy (RCA)")
print("CAT-2 Term-1 Y-2")
print("Course Title: Embedded Systems")
print("Date: 2021-12-08")
print("Duration : 2 hours")
print("Total: 10 marks")
print("=================================\n")
def isListed(st):
    print("Verifying...")
    result = popen("curl --request POST --form student_id="+st+" http://192.168.0.82/Y2-CAT2-Term1-2021~2022/?rq=verify").read()
...
def saveAnswer(arg,n, flag):
    ...
    cmd="curl --request POST --form flag="+flag+"  --form  student_id="+student_id+" --form  answer="+arg+" http://192.168.0.82/Y2-CAT2-Term1-2021~2022/?rq=insert"
    system(cmd)
    print("+++++++++++++++++++++++++++++++++++")
    print("\n")

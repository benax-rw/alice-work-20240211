...
print("Good News: Having arrived here you already have 10 marks and if you really created a web and successfully published it using netcat you additionally have 12 marks.\nNow it's time to report!")
print("=================================\n")
def isListed(st):
    print("Verifying...")
